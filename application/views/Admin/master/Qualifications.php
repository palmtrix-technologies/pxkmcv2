 ...
 <div class="hk-pg-wrapper">
            ...
            <span class="new-button"><a href="<?php echo base_url(); ?>newqualification" class="btn btn-sm"><span class="fa fa-plus"></span> &nbsp;Add New</a></span>
</div>
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <table id="datable_3" class="table table-hover w-100 display">
                                            ...
                                            <?php $i=1;
                        foreach ($qualifications as $key => $value1)
                         {  
                        	?>
                     <tr>
                        <td class="text-center"><?php echo $i;?></td>
                        <td class="text-center"><?php echo $value1->qualification_name;?></td>
