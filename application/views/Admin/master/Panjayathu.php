 ...
 <div class="hk-pg-wrapper">
            ...
            <span class="new-button"><a href="<?php echo base_url(); ?>newpanjayath" class="btn btn-sm"><span class="fa fa-plus"></span> &nbsp;Add New</a></span>
</div>
                                        ...
                                        <table id="datable_3" class="table table-hover w-100 display">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;">PANJAYATH</th>
                                                    <th style="text-align:center;">TYPES</th>
                                                    <th style="text-align:center;">MANDALAM</th>
                                            ...
                                            <?php $i=1;
                        foreach ($panjayathu as $key => $value1)
                         {  
                        	?>
                     <tr>
                        <td class="text-center"><?php echo $i;?></td>
                        <td class="text-center"><?php echo $value1->name;?></td>
                        <td class="text-center"><?php echo $value1->types;?></td>
                        <td class="text-center"><?php echo $value1->mandalam_name;?></td>
