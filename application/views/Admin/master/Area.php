 ...
 <div class="hk-pg-wrapper">
            ...
            <span class="new-button"><a href="<?php echo base_url(); ?>newarea" class="btn btn-sm"><span class="fa fa-plus"></span> &nbsp;Add New</a></span>
</div>
...
">
                                        ...
                                        <table id="datable_3" class="table table-hover w-100 display">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;">Emirates</th>
                     ...
                     <tr>
                        ...
                        <td class="text-center"><?php echo $value1->area_name;?></td>
                        <td class="text-center"><?php echo $value1->emirates_name;?></td>
