    ...
    <div class="page slidepage" style="align-items:">
            ...
            <div class="field">
               <div class="label required">Date of Expiry</div>
                <input type="date" class="form-control" required name="date_of_expiry" placeholder="Date of Expiry">
            </div>
              <div class="field">
                            <div class="label required">Mobile Number</div>
                            <input type="text" class="form-control" required name="mobile_number" placeholder="Mobile Number">
                        </div>
<input type="checkbox" style="margin:-38px 0 0 0 ;height: 18;width: 18px;">
                        ...
                        <div class="" style="display:inline-flex;margin-bottom: -30px;margin-top: 40px;left:50%;transform: translateX(-29%);">
                            ...
                            <button class="upload-button2" style="height: 43px;width: 150px;font-size: 6px;line-height: 30px;border-color: #388e3c;background-color: #e8f5e9;border-radius: 10px;">
...
<div class="">
         <button class="upload-button3" style="height: 43px;width: 150px;font-size: 6px;line-height: 30px;border-color: #388e3c;background-color: #e8f5e9;border-radius: 10px;">
                            
                             <label for="myfile" style="color: #388e3c;">Profile Picture</label>
                             <input type="file" id="myfile2" name="profile_picture">
        </button> 
        </div>
...
$(function(){
    ...
    e.preventDefault(); 
         $.ajax({
             url:'<?php echo base_url() ?>membership-step1-add',
             type:"post",
             ...
             async:false,
              success: function(data){
                ...
                if(obj.error){
                    ...
                    if(obj.isvalidemaratesidnumber && obj.isvalidemaratesname){
                    window.location.href = "<?php echo base_url('membership-step2') ?>/" + obj.id;  
                    }
                    else{
                        alert("Emirates ID and data mismatch");
                    }
